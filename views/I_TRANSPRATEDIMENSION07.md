...
tags:
  ...
  - lob:Other
---
# I_TRANSPRATEDIMENSION07

**Transpratedimension 07**
...
@Analytics.technicalName: 'IRATEDIMN07'
@EndUserText: {label: 'Rate Table 7 Dimensional Rates'}
@ObjectModel: {sapObjectNodeType.name: 'TranspRateTableDimension07',
...
define view entity I_TranspRateDimension07
  as select from /scmtms/d_tcrt7d as TranspRateDimn
