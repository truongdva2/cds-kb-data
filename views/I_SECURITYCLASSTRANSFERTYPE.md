...
semantic_en: "security class transfer type master — SecurityClassTransferType codes"
semantic_vi: "Dữ liệu chính loại chuyển nhượng lớp chứng chỉ — mã loại chuyển nhượng"
keywords:
  - loại chuyển nhượng chứng chỉ
  - mã chuyển nhượng
