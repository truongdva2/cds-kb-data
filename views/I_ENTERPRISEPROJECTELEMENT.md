...
| `EntProjectSettlementElement` | `task.entprojectsettlementelement` |
| `EntProjIsSettlmtRuleInherited` | `task.entprojissettlmtruleinherited` |
| `EntProjProfitabilitySegment` | `task.entprojprofitabilitysegment` |
| `_Project` | *Association* |
| `_ParentElement` | *Association* |
...
| `_ParentElement` | `I_EnterpriseProjectElement` | [0..1] |
...
@ObjectModel: {
   ...
   alternativeKey: [{ id: 'WBSElementInternalID', element: ['WBSElementInternalID'], uniqueness: #UNIQUE },
                    { id: 'ProjectElement',       element: ['ProjectElement'],       uniqueness: #UNIQUE }],
