...
| `CAStandardCompanyCode` | `CAStandardCompanyCode` |
...
| `_AlternativePayerAddress` | *Association* |
...
| `_BankForIncomingPayment` | *Association* |
| `_BankForOutgoingPayment` | *Association* |
...
| `_CADetnCodeForAltvInvcFm` | *Association* |
...
| `_PaytCardForIncomingPayment` | *Association* |
| `_PaytCardForOutgoingPayment` | *Association* |
