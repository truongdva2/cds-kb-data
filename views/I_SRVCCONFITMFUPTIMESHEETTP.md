...
tags:
  ...
  - lob:Other
---
# I_SRVCCONFITMFUPTIMESHEETTP

**Srvcconfitmfuptimesheettp**
...
```abap
@EndUserText.label: 'Item Follow-Up Time Sheet - TP'
...
define view entity I_SrvcConfItmFUPTimeSheetTP as projection on R_SrvcConfItmFUPTimeSheetTP {
