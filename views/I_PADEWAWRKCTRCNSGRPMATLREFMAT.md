...
---
# I_PADEWAWRKCTRCNSGRPMATLREFMAT

**Padewawrkctrcnsgrpmatlrefmat**
...
| `EWMWorkCenter` | `PaInDetRec.workcenter` |
| `EWMConsolidationGroup` | `PaInDetRec.consolidation_group` |
...
@EndUserText.label: 'PaDeWa for WrkCtr/CnsGrp/Matl/RefMat'
...
define view entity I_PaDeWaWrkCtrCnsGrpMatlRefMat
  as select from kotp481 as PaInDetRec
...

{
  ...
  key  PaInDetRec.workcenter                                       as EWMWorkCenter,
  key  PaInDetRec.consolidation_group                              as EWMConsolidationGroup,
