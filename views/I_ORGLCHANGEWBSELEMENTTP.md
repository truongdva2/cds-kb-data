...
tags:
  ...
  - bo:WBS
---
# I_ORGLCHANGEWBSELEMENTTP

**Orglchangewbselementtp**
...
```abap
@EndUserText.label:                      'Organizational Change WBS Elements - TP'
...
define view entity I_OrglChangeWBSElementTP
  as projection on R_OrglChangeWBSElementTP as WBSElement
