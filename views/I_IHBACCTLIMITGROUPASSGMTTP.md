...
tags:
  ...
  - lob:Other
---
# I_IHBACCTLIMITGROUPASSGMTTP

**Ihbacctlimitgroupassgmttp**
...
```abap
@EndUserText.label: 'IHB Group Assignment - TP'
...
define view entity I_IHBAcctLimitGroupAssgmtTP
  as projection on R_IHBGroupAssignmentTP as InhouseBankLimitGroupAssgmt
{
