...
semantic_en: "Enumeration Value Character 4 — domain values for four-character type enumeration."
semantic_vi: "Giá trị liệt kê Ký tự 4 — giá trị miền cho liệt kê kiểu bốn ký tự."
keywords:
  - liệt kê
  - kiểu dữ liệu
  - bốn ký tự
