...
tags:
  ...
  - bo:HeaderPickgIncompletionStatus
---
# I_HDRPICKGINCOMPLTNSTATUST

**Hdrpickgincompltnstatust**
...
| Field | Data Source |
|---|---|
| `HeaderPickgIncompletionStatus` | `statu` |
| `Language` | `spras` |
| `HdrPickgIncompltnStatusDesc` | `bezei` |
...
@EndUserText.label: 'Header Picking Incompletion Sts - Text'
@VDM.viewType: #BASIC
@AccessControl.authorizationCheck:#NOT_REQUIRED
@AbapCatalog.sqlViewName: 'ISDHPIKINCPSTST'
@Metadata.ignorePropagatedAnnotations:true
@Search.searchable: true

/*+[hideWarning] { "IDS" : [ "CALCULATED_FIELD_CHECK" ]  } */
define view I_HdrPickgIncompltnStatusT
  ...
  association [0..1] to I_Language                as _Language                      on $projection.Language = _Language.Language
{
      ...
      @ObjectModel.text.element: ['HdrPickgIncompltnStatusDesc']
  key statu as HeaderPickgIncompletionStatus,
  ...
  key spras as Language,
      ...
      @Search.ranking: #LOW
      @Semantics.text: true
      bezei as HdrPickgIncompltnStatusDesc,
