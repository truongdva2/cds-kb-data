...
tags:
  ...
  - bo:Plant
---
# I_PAINDETREFMATPLANTSTORLOC

**Paindetrefmatplantstorloc**
...
@EndUserText.label: 'PaInDet for RefMat/Plant/Storage Loc'
...
define view entity I_PaInDetRefMatPlantStorLoc
  as select from kotp492 as PaInDetRec
