...
---
# I_PAINDETMATLSHIPTOPARTYUSAGE

**Paindetmatlshiptopartyusage**
...
@EndUserText.label: 'PaInDet for Material/Ship-to Party/Usage'
...
define view entity I_PaInDetMatlShipToPartyUsage
  as select from kotp110 as PaInDetRec
