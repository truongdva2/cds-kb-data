...
```abap
@EndUserText.label: 'Credit Mgmt BP Creditinsurance - TP'
...
define view entity I_CrdtMgmtBPCreditInsuranceTP
as projection on R_CrdtMBPCreditInsuranceTP as CrdtMgmtBPCreditInsurance
{
  key BusinessPartner,
  key CreditSegment,
