...
semantic_en: "Enumeration Value INT2 with Text — integer INT2 enumeration values with translated text labels."
semantic_vi: "Giá trị liệt kê INT2 có văn bản — giá trị liệt kê số nguyên INT2 với nhãn văn bản được dịch."
keywords:
  - liệt kê
  - bản dịch
  - INT2
...
---
# DDCDS_TYPE_ENUMVAL_INT2_T_SCP

**Ddcds Type Enumval Int 2 T Scp**
...
| `enumValue` | `cast( enum_t.enumValue as abap.int2 )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_int2_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values INT2 Texts'
define view entity ddcds_type_enumval_int2_t_scp 
  as select from dd_drty_st_enum_value_t_int2 as enum_t
  ...
  association to parent ddcds_type_enumval_int2_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                     ...
                                                                     and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.int2 )       as enumValue,
  key enum_t.language,
