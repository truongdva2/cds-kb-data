...
tags:
  ...
  - bo:Material
---
# I_PAINDETREFERENCEMATERIAL

**Paindetreferencematerial**
...
@EndUserText.label: 'PaInDet for Reference Material'
...
define view entity I_PaInDetReferenceMaterial
  as select from kotp499 as PaInDetRec
