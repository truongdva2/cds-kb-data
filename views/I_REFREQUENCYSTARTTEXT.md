...
| `REFrequencyStart` | `cast( dd07t.domvalue_l as recdvdmmonthfrom )` |
| `DomainValue` | `dd07t.domvalue_l` |
| `REFrequencyStartName` | `cast( dd07t.ddtext as val_text preserving type )` |
...
|---|---|---|
| `_REFrequencyStart` | `I_REFrequencyStart` | — |
