...
```abap
@EndUserText.label: 'Balance of Payments Form To Country/Reg' 
@AbapCatalog.sqlViewName: 'IBOPFORM2CNTRY' 
...
define view I_BOPFormToCntry as

select from glo_t_bopsubdiv
...
   
  ...
  key form    as BOPForm,
  key cast(subdiv as land1_gp) as Country,
