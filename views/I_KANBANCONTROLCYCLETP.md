...
@EndUserText.label: 'Kanban Control Cycle - TP'

@ObjectModel.usageType: {serviceQuality: #C, sizeCategory: #L, dataClass: #MIXED}
@ObjectModel.sapObjectNodeType.name: 'KanbanControlCycle'
...
define root view entity I_KanbanControlCycleTP
  provider contract transactional_interface
  as projection on R_KanbanControlCycleTP as _KanbanControlCycleTP
{
  ...
  key KanbanControlCycle,
      ...
      _KanbanContainer: redirected to composition child I_KanbanContainerTP
}
```
