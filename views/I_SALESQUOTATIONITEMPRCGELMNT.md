...
@EndUserText.label: 'Sales Quotation Item Pricing Element'
@VDM: {
  viewType: #BASIC,
...
define view I_SalesQuotationItemPrcgElmnt as select from I_SalesDocItemPricingElement       as PricingElement
