...
```abap
@EndUserText.label: 'GHG Scope - Text'
@AccessControl.authorizationCheck: #NOT_REQUIRED
@Metadata.ignorePropagatedAnnotations: true

@ObjectModel.dataCategory: #TEXT
@ObjectModel.modelingPattern: #LANGUAGE_DEPENDENT_TEXT
@ObjectModel.representativeKey: 'GHGScope'
...
@ObjectModel.sapObjectNodeType.name: 'GreenhouseGasScopeText'
...
define view entity I_GHGScopeText as select from dd07t 
  association [0..1] to I_Language as _Language on $projection.Language = _Language.Language
{
  ...
  key cast( dd07t.domvalue_l as sufnd_vdm_ghgscope ) as GHGScope,
  
      @Search.defaultSearchElement: true
      @Search.fuzzinessThreshold: 0.8
      @Search.ranking: #LOW
      @Semantics.text: true
      cast( dd07t.ddtext as sufnd_vdm_ghgscopename preserving type ) as GHGScopeName,
      
      _Language
} 
where dd07t.domname  = 'SUFND_VDM_GHGSCOPE'
