...
| `SlsOrdWthoutChrgItemCategory` | `SalesDocumentItemCategory` |
| `SalesOrderWthoutChrgItemType` | `SalesDocumentItemType` |
...
| `SalesOrderWthoutChrgItemText` | `SalesDocumentItemText` |
