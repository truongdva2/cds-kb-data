...
tags:
  ...
  - lob:Other
---
# I_LEGALCONTEXTINTCONTACTTP

**Legalcontextintcontacttp**
...
| Field | Data Source |
|---|---|
| `LglCntntMCntxtIntCntctUUID` | `LglCntntMCntxtIntCntctUUID` |
...
@EndUserText.label: 'Legal Context Internal Contacts - TP'
@ObjectModel: {
    usageType: {
        sizeCategory: #L,
        serviceQuality: #C,
...
define view entity I_LegalContextIntContactTP
  as projection on I_LCMCtxIntContactTP as LegalContextInternalContact
{
