...
---
# DDCDS_TYPE_ENUMVAL_NUMC2_T_SCP

**Ddcds Type Enumval Numc 2 T Scp**
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC2 Texts'
define view entity ddcds_type_enumval_numc2_t_scp 
  as select from dd_drty_st_enum_value_t_numc_2 as enum_t
  ...
  association to parent ddcds_type_enumval_numc2_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                     ...
                                                                     and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.numc(2) )       as enumValue,
  key enum_t.language,
