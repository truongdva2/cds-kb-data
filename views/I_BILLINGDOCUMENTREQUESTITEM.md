...
| `_ReferenceDocSDDocCategory` | *Association* |
...
| `_Partner` | `I_BillingDocReqItemPartner` | [0..*] |
| `_PricingElement` | `I_BillingDocReqItemPrcgElmnt` | [0..*] |
| `_HigherLevelItem` | `I_BillingDocumentRequestItem` | [1..1] |
