...
```abap
@EndUserText.label: 'GHG Data Quality Characteristic'
...
define view entity I_GHGDtaQltyCharacteristicVH
  as select from I_GHGDtaQltyCharacteristic
{
      @ObjectModel.text.association: '_Text'
  key GHGDataQualityCharacteristic,
