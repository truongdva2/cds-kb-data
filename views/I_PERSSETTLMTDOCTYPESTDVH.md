...
---
# I_PERSSETTLMTDOCTYPESTDVH

**Perssettlmtdoctypestdvh**
...
```abap
@EndUserText.label: 'Settlement Doc Type for Personnel Settlements'
@AccessControl: { 
...
define view entity I_PersSettlmtDocTypeStdVH
...
where
  SAPObjectType = 'PersonnelSettlementDocument'
```
