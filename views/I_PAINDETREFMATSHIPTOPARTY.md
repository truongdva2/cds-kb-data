---
name: I_PAINDETREFMATSHIPTOPARTY
description: Paindetrefmatshiptoparty
semantic_en: "packing instruction details by reference material and ship-to party — condition type, validity dates, and system UUIDs."
semantic_vi: "chi tiết hướng dẫn đóng gói theo vật liệu tham chiếu và bên nhận hàng — loại điều kiện, ngày hiệu lực và UUID hệ thống."
keywords:
  - hướng dẫn đóng gói
  - vật liệu tham chiếu
  - bên nhận hàng
...
---
# I_PAINDETREFMATSHIPTOPARTY

**Paindetrefmatshiptoparty**
...
@EndUserText.label: 'PaInDet for RefMat/Ship-to Party'
...
define view entity I_PaInDetRefMatShipToParty
  as select from kotp491 as PaInDetRec
