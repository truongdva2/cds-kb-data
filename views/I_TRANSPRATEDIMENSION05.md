...
tags:
  ...
  - lob:Other
---
# I_TRANSPRATEDIMENSION05

**Transpratedimension 05**
...
@Analytics.technicalName: 'IRATEDIMN05'
@EndUserText: {label: 'Rate Table 5 Dimensional Rates'}
@ObjectModel: {sapObjectNodeType.name: 'TranspRateTableDimension05',
...
define view entity I_TranspRateDimension05
  as select from /scmtms/d_tcrt5d as TranspRateDimn
