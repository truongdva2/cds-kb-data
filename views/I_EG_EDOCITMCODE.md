...
| `EG_EDocMaterial` | `EG_EDocMaterial` |
...
@EndUserText.label: 'eDocument Egypt Item Code for Material'
...
define view entity I_EG_EDocItmCode as select from R_EG_EDocItmCode
{
key CompanyCode,           
key EG_EDocMaterial,  
EG_EDocItmType,  
