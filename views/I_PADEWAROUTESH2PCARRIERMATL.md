...
---
# I_PADEWAROUTESH2PCARRIERMATL

**Padewaroutesh 2PCARRIERMATL**
...
| `EWMRoute` | `PaInDetRec.ewm_route` |
| `ShipToParty` | `PaInDetRec.kunwe` |
| `Carrier` | `PaInDetRec.carrier` |
...
@EndUserText.label: 'PaDeWa for Route/ShpToPty/Carrier/Matl'
...
define view entity I_PaDeWaRouteSh2PCarrierMatl
  as select from kotp472 as PaInDetRec
...

{
  ...
  key  PaInDetRec.ewm_route                                        as EWMRoute,
       @ObjectModel.foreignKey.association: '_ShipToParty'
  key  PaInDetRec.kunwe                                            as ShipToParty,
       @ObjectModel.foreignKey.association: '_Carrier'
  key  PaInDetRec.carrier                                          as Carrier,
