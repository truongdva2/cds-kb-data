...
| Field | Data Source |
|---|---|
| `ConsolidationSignLogicType` | `ConsolidationSignLogicType` |
| `ConsolidationSignLogicTypeText` | `_Text[1: Language=$session.system_language].ConsolidationSignLogicTypeText` |
