...
@EndUserText.label: 'Collection Strategy - Text'
...
define view entity I_CACollectionStrategyText
  as select from tfk047xt
...

{
  ...
  key spras     as Language,
      ...
      @Semantics.text
      strattext as CACollectionStrategyName,
