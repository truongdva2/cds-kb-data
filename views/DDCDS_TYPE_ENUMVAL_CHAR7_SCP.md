...
semantic_en: "Enumeration Value Character 7 — domain values for seven-character type enumeration."
semantic_vi: "Giá trị liệt kê Ký tự 7 — giá trị miền cho liệt kê kiểu bảy ký tự."
keywords:
  - liệt kê
  - kiểu dữ liệu
  - bảy ký tự
...
| `enumValue` | `cast( enum.enumValue as abap.char(7) )` |
| `_Text` | *Association* |
...
|---|---|---|
| `_Text` | `ddcds_type_enumval_char7_t_scp` | [0..*] |
...
@EndUserText.label: 'CDS Simple Type: Enum Values CHAR7'
define view entity ddcds_type_enumval_char7_scp
  as select from dd_drty_st_enum_values_char_7 as enum
  ...
  composition [0..*] of ddcds_type_enumval_char7_t_scp as _Text
{
  ...
  key cast( enum.enumValue as abap.char(7) )       as enumValue,
      _Text
}
```
