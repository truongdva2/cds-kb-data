...
tags:
  ...
  - lob:Other
---
# I_REVALNLIABILITYCASHFLOW

**Revalnliabilitycashflow**
...
@EndUserText.label: 'Real Estate Valn Liability Cash Flow'
@Analytics: {
...
@ObjectModel: {
  ...
  sapObjectNodeType.name: 'REValuationLiabilityCashFlow'
}
@Metadata.ignorePropagatedAnnotations: true
@Metadata.allowExtensions: true
@VDM.viewType: #COMPOSITE
define view entity I_REValnLiabilityCashFlow
                                                                                     ...
                                                                                     and $projection.taxcalculationprocedure = _TaxJurisdiction.TaxJurisdictionCalcProcedure
{
  ...
  key REValuationCashflow.REValuationCashFlowRecordUUID,
      ...
      case when REValuationCashflow.RECashFlowType = '1' or REValuationCashflow.RECashFlowType = '3'
      then
...
where
  ...
  and REValuationCashflow.RERelshpBookedToFlowType <> 'CEG'
  and REValuationCashflow.RERelshpBookedToFlowType <> 'CEH'
  or  REValuationCashflow.RECashFlowType           =  '7'
  or  REValuationCashflow.RECashFlowType           =  '3'
  or  REValuationCashflow.RECashFlowType           =  '4'
  and REValuationCashflow.RERelshpBookedToFlowType <> 'CEI'
  and REValuationCashflow.RERelshpBookedToFlowType <> 'CEJ'
```
