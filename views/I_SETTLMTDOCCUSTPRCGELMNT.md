...
---
# I_SETTLMTDOCCUSTPRCGELMNT

**Settlmtdoccustprcgelmnt**
...
```abap
@EndUserText: { 
  label: 'Settlmt Doc Customer Pricing Element'
}
@VDM: {
  viewType: #COMPOSITE,
...
define view entity I_SettlmtDocCustPrcgElmnt
  as select from R_SettlmtDocCustPrcgElmnt
