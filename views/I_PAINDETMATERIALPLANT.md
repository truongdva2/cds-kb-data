...
tags:
  ...
  - bo:Plant
---
# I_PAINDETMATERIALPLANT

**Paindetmaterialplant**
...
@EndUserText.label: 'PaInDet for Material/Plant'
...
define view entity I_PaInDetMaterialPlant
  as select from kotp200 as PaInDetRec
