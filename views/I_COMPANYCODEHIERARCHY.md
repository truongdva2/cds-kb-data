...
| Field | Data Source |
|---|---|
| `CompanyCodeHierarchy` | `cast ( hrrp_dir_n.hryid_42 as fis_hryid_ccode_42 preserving type )` |
...
|---|---|---|
| `_Text` | `I_CompanyCodeHierarchyT` | [1..*] |
...
@ObjectModel.sapObjectNodeType.name: 'CompanyCodeHierarchy'
