...
---
# DDCDS_TYPE_ENUMVAL_NUMC1_SCP

**Ddcds Type Enumval Numc 1 Scp**
...
| `enumValue` | `cast( enum.enumValue as abap.numc(1) )` |
| `_Text` | *Association* |
...
|---|---|---|
| `_Text` | `ddcds_type_enumval_numc1_t_scp` | [0..*] |
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC1'
define view entity ddcds_type_enumval_numc1_scp
  as select from dd_drty_st_enum_values_numc_1 as enum
  ...
  composition [0..*] of ddcds_type_enumval_numc1_t_scp as _Text
{
  ...
  key cast( enum.enumValue as abap.numc(1) )       as enumValue,
      _Text
}
```
