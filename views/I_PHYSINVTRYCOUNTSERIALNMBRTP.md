...
---
# I_PHYSINVTRYCOUNTSERIALNMBRTP

**Physinvtrycountserialnmbrtp**
...
@EndUserText.label: 'Count Serial Number - TP'
...
define view entity I_PhysInvtryCountSerialNmbrTP 
  as projection on R_PhysInvtryCountSerialNmbrTP {
