...
|---|---|---|
| `_Text` | `I_AdditionalCustomerGroup4Text` | [0..*] |
...
@ObjectModel.supportedCapabilities: [ #ANALYTICAL_DIMENSION,
                                      ...
                                      #SQL_DATA_SOURCE,
                                      #VALUE_HELP_PROVIDER ]
@EndUserText.label: 'Additional Customer Group 4'
@Analytics.dataCategory: #DIMENSION
@Analytics.dataExtraction.enabled: true
@VDM.viewType: #BASIC
@AccessControl.authorizationCheck:  #NOT_REQUIRED
@AbapCatalog.sqlViewName: 'ISDADDLCUSTGRP4'
@AbapCatalog.buffering.status: #ACTIVE
@AbapCatalog.buffering.type: #FULL
@Metadata.ignorePropagatedAnnotations: true
@ObjectModel.sapObjectNodeType.name: 'AdditionalCustomerGroup4'
@Search.searchable: true
@Consumption.ranked: true
@ObjectModel.dataCategory: #VALUE_HELP

define view I_AdditionalCustomerGroup4
as select from tvv4

association [0..*] to I_AdditionalCustomerGroup4Text as _Text on $projection.AdditionalCustomerGroup4  = _Text.AdditionalCustomerGroup4
{
