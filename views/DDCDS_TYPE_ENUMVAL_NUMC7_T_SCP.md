...
---
# DDCDS_TYPE_ENUMVAL_NUMC7_T_SCP

**Ddcds Type Enumval Numc 7 T Scp**
...
| `enumValue` | `cast( enum_t.enumValue as abap.numc(7) )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_numc7_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC7 Texts'
define view entity ddcds_type_enumval_numc7_t_scp
  as select from dd_drty_st_enum_value_t_numc_7 as enum_t
  ...
  association to parent ddcds_type_enumval_numc7_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                   ...
                                                                   and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumIdentifier as abap.char(30) ) as enumIdentifier,
      @EndUserText.label: 'Enum Value Numc 7'
  key cast( enum_t.enumValue as abap.numc(7) )       as enumValue,
  key enum_t.language,
