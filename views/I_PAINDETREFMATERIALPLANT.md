...
tags:
  ...
  - bo:Plant
---
# I_PAINDETREFMATERIALPLANT

**Paindetrefmaterialplant**
...
@EndUserText.label: 'PaInDet for Reference Material/Plant'
...
define view entity I_PaInDetRefMaterialPlant
  as select from kotp493 as PaInDetRec
