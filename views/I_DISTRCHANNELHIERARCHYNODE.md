...
| Field | Data Source |
|---|---|
| `DistributionChannelHierarchy` | `cast(hrrp_node_n.hryid as fis_hryid_distrchnl preserving type )` |
...
| `DistributionChannel` | `hrrp_node_n.vtweg` |
...
|---|---|---|
| `_Text` | `I_DistrChannelHierarchyNodeT` | [0..*] |
| `_DistributionChannel` | `I_DistributionChannel` | [0..1] |
| `_Hierarchy` | `I_DistrChannelHierarchy` | [1..1] |
