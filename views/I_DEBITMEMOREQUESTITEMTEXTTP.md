...
semantic_en: "Debit memo request item text TP — text documents for debit memo items by language and text identifier."
semantic_vi: "Văn bản mục yêu cầu ghi nợ — tài liệu mô tả dài cho mục ghi nợ theo ngôn ngữ."
keywords:
  - Văn bản mục ghi nợ
  - Tài liệu
  - Mô tả
