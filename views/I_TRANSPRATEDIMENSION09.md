...
tags:
  ...
  - lob:Other
---
# I_TRANSPRATEDIMENSION09

**Transpratedimension 09**
...
@Analytics.technicalName: 'IRATEDIMN09'
@EndUserText: {label: 'Rate Table 9 Dimensional Rates'}
@ObjectModel: {sapObjectNodeType.name: 'TranspRateTableDimension09',
...
define view entity I_TranspRateDimension09
  as select from /scmtms/d_tcrt9d as TranspRateDimn
