...
---
# DDCDS_TYPE_ENUMVAL_NUMC4_SCP

**Ddcds Type Enumval Numc 4 Scp**
...
| `enumValue` | `cast( enum.enumValue as abap.numc(4) )` |
| `_Text` | *Association* |
...
|---|---|---|
| `_Text` | `ddcds_type_enumval_numc4_t_scp` | [0..*] |
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC4'
define view entity ddcds_type_enumval_numc4_scp
  as select from dd_drty_st_enum_values_numc_4 as enum
  ...
  composition [0..*] of ddcds_type_enumval_numc4_t_scp as _Text
{
  ...
  key cast( enum.enumValue as abap.numc(4) )       as enumValue,
      _Text
}
```
