...
---
# DDCDS_TYPE_ENUMVAL_INT1_T_SCP

**Ddcds Type Enumval Int 1 T Scp**
...
| `enumValue` | `cast( enum_t.enumValue as abap.int1 )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_int1_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values INT1 Texts'
define view entity ddcds_type_enumval_int1_t_scp 
  as select from dd_drty_st_enum_value_t_int1 as enum_t
  ...
  association to parent ddcds_type_enumval_int1_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                     ...
                                                                     and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.int1 )       as enumValue,
  key enum_t.language,
