...
```abap
@AbapCatalog.sqlViewName: 'CSIWFEMLDCRSN'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@AccessControl.personalData.blocking: #NOT_REQUIRED
@EndUserText.label: 'Approve or Reject Email for Invoice'
...
define view C_SuplrInvcWrkflwEmlDcsnRsn
...
where
  ...
  and _Workflowtask.WorkflowTaskDefinition = 'WS00800303'
```
