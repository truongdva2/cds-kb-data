...
```abap
@EndUserText.label: 'Production Order Confirmation - TP'
...
define root view entity I_ProductionOrdConfirmationTP 
  provider contract transactional_interface
  as projection on R_ProductionOrdConfirmationTP {
  // Key
  ...
  /* Associations */
  _ProdnOrdConfMatlDocItm : redirected to composition child I_ProdnOrdConfMatlDocItemTP
}
```
