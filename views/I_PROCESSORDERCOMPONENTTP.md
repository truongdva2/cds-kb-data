...
@ObjectModel.sapObjectNodeType.name: 'ProcessOrderComponent'
...
define view entity I_ProcessOrderComponentTP 
as projection on R_ProcessOrderComponentTP as Component
{
      // Key      
  key Reservation,      
  key ReservationItem,     
