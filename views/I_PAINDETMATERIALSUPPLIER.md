...
semantic_en: "packing instruction details by material and supplier — condition type, validity dates, and system UUIDs."
semantic_vi: "chi tiết hướng dẫn đóng gói theo vật liệu và nhà cung cấp — loại điều kiện, ngày hiệu lực và UUID hệ thống."
keywords:
  - hướng dẫn đóng gói
  - vật liệu
  - nhà cung cấp
...
tags:
  ...
  - bo:Supplier
---
# I_PAINDETMATERIALSUPPLIER

**Paindetmaterialsupplier**
...
| `_Supplier` | `I_BusinessPartner` | [0..1] |
...
@EndUserText.label: 'PaInDet for Material/Supplier'
...
define view entity I_PaInDetMaterialSupplier
  as select from kotp400 as PaInDetRec
...

{
  ...
  key  PaInDetRec.lifnr                                            as Supplier,
