...
tags:
  ...
  - lob:Other
---
# I_PRODCMPLNCWAYOFAPPLTP

**Prodcmplncwayofappltp**
...
@EndUserText.label: 'Way of Application - TP'
...
define view entity I_ProdCmplncWayOfApplTP
  as projection on R_ProdCmplncWayOfApplTP 
{

  key ProdCmplncWayOfApplUUID,
      ProdCmplncUseUUID,
