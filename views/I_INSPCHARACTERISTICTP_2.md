...
---
# I_INSPCHARACTERISTICTP_2

**Inspcharacteristictp 2**
...
define view entity I_InspCharacteristicTP_2
  as projection on R_InspectionCharacteristicTP
{
  key InspectionLot,
  ...
  key InspectionCharacteristic,
      ...
      _InspectionResult    : redirected to composition child I_InspectionResultTP_2
