...
| Field | Data Source |
|---|---|
| `DependentRqmtMRPRelevance` | `cast(substring(l.domvalue_l, 1, 1) as pph_ahdis preserving type)` |
...
|---|---|---|
| `_Text` | `I_DepdntRqmtMRPRelevanceText` | [0..*] |
