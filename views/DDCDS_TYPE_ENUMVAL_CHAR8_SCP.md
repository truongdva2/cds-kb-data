...
---
# DDCDS_TYPE_ENUMVAL_CHAR8_SCP

**Ddcds Type Enumval Char 8 Scp**
...
| `enumValue` | `cast( enum.enumValue as abap.char(8) )` |
| `_Text` | *Association* |
...
|---|---|---|
| `_Text` | `ddcds_type_enumval_char8_t_scp` | [0..*] |
...
@EndUserText.label: 'CDS Simple Type: Enum Values CHAR8'
define view entity ddcds_type_enumval_char8_scp
  as select from dd_drty_st_enum_values_char_8 as enum
  ...
  composition [0..*] of ddcds_type_enumval_char8_t_scp as _Text
{
  ...
  key cast( enum.enumValue as abap.char(8) )       as enumValue,
      _Text
}
```
