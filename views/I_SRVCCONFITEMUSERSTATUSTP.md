...
tags:
  ...
  - lob:Other
---
# I_SRVCCONFITEMUSERSTATUSTP

**Srvcconfitemuserstatustp**
...
```abap
@EndUserText.label: 'Service Confirmation Item User Status - TP'
...
define view entity I_SrvcConfItemUserStatusTP
  as projection on R_SrvcConfItemUserStatusTP
{
