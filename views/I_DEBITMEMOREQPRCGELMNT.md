...
@EndUserText.label: 'Debit Memo Request Pricing Element'
@VDM: {
  viewType: #BASIC,
...
define view I_DebitMemoReqPrcgElmnt as select from I_SalesDocumentPricingElement       as PricingElement
