...
---
# DDCDS_TYPE_ENUMVAL_CHAR4_T_SCP
...
| `enumValue` | `cast( enum_t.enumValue as abap.char(4) )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_char4_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values CHAR4 Texts'
define view entity ddcds_type_enumval_char4_t_scp 
  as select from dd_drty_st_enum_value_t_char_4 as enum_t
  ...
  association to parent ddcds_type_enumval_char4_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                     ...
                                                                     and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.char(4) )       as enumValue,
  key enum_t.language,
