...
```abap
@EndUserText.label: 'IHB Fee Group Assgmt - TP'
...
define view entity I_IHBFeeGroupAssgmtTP
  as projection on R_IHBGroupAssignmentTP as InHouseBankFeeGroupAssgmt
{
