...
| Field | Data Source |
|---|---|
| `PackingStatus` | `substring(dd07l.domvalue_l, 1, 1)` |
| `_Text` | *Association* |
...
@AbapCatalog.sqlViewName: 'ISDPACKINGSTS'
@Metadata.ignorePropagatedAnnotations:true
@Metadata.allowExtensions: true
@ObjectModel.supportedCapabilities: [ #SQL_DATA_SOURCE, #CDS_MODELING_DATA_SOURCE, #ANALYTICAL_DIMENSION ]
@ObjectModel.modelingPattern: [ #ANALYTICAL_DIMENSION ]
@ObjectModel.sapObjectNodeType.name: 'ItemPackingStatus'

define view I_PackingStatus 
as select from dd07l

association [0..*] to I_PackingStatusText as _Text on $projection.PackingStatus = _Text.PackingStatus
{
    @ObjectModel.text.association: '_Text'
    key substring(dd07l.domvalue_l, 1, 1) as PackingStatus,
