...
**Ddcds Type Enumval Numc 3 T Scp**
...
| `enumValue` | `cast( enum_t.enumValue as abap.numc(3) )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_numc3_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC3 Texts'
define view entity ddcds_type_enumval_numc3_t_scp 
  as select from dd_drty_st_enum_value_t_numc_3 as enum_t
  ...
  association to parent ddcds_type_enumval_numc3_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                     ...
                                                                     and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.numc(3) )       as enumValue,
  key enum_t.language,
