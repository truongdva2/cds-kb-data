...
```abap
@AbapCatalog.sqlViewName: 'IPRODPERKZTXT'
...
@EndUserText.label: 'Product Consumption Period - Text'
...
@ObjectModel.supportedCapabilities: [#SQL_DATA_SOURCE,
                                     ...
                                     #SEARCHABLE_ENTITY ]
define view I_ProductConsumptionPeriodText
