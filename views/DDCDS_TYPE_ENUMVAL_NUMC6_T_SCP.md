...
semantic_en: "Enumeration Value Numeric 6 with Text — numeric NUMC6 enumeration values with translated text labels."
semantic_vi: "Giá trị liệt kê Số 6 có văn bản — giá trị liệt kê số NUMC6 với nhãn văn bản được dịch."
keywords:
  - liệt kê
  - bản dịch
  - NUMC6
...
---
# DDCDS_TYPE_ENUMVAL_NUMC6_T_SCP

**Ddcds Type Enumval Numc 6 T Scp**
...
| `enumValue` | `cast( enum_t.enumValue as abap.numc(6) )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_numc6_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC6 Texts'
define view entity ddcds_type_enumval_numc6_t_scp 
  as select from dd_drty_st_enum_value_t_numc_6 as enum_t
  ...
  association to parent ddcds_type_enumval_numc6_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                     ...
                                                                     and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.numc(6) )       as enumValue,
  key enum_t.language,
