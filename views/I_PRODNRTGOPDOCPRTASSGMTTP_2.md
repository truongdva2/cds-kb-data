...
```abap
@EndUserText.label: 'Interface for BO ProductionRouting Doc PRT Assignment - TP'
...
define view entity I_ProdnRtgOpDocPRTAssgmtTP_2
  as projection on R_ProdnRtgOpDocPRTAssgmtTP_2
{
