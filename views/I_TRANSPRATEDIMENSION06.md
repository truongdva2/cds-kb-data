...
tags:
  ...
  - lob:Other
---
# I_TRANSPRATEDIMENSION06

**Transpratedimension 06**
...
@Analytics.technicalName: 'IRATEDIMN06'
@EndUserText: {label: 'Rate Table 6 Dimensional Rates'}
@ObjectModel: {sapObjectNodeType.name: 'TranspRateTableDimension06',
...
define view entity I_TranspRateDimension06
  as select from /scmtms/d_tcrt6d as TranspRateDimn
