...
define view entity I_CAInvcgDocItemTP
  as projection on R_CAInvcgDocItemTP as _CAInvcgDocItemTP
{
  ...
  key CAInvcgDocItem,
      ...
      _CAInvcgDocument : redirected to parent I_CAInvcgDocumentTP,
