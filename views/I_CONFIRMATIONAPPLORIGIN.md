...
tags:
  ...
  - lob:Manufacturing
  - bo:OrderConfirmationOriginAppl
---
# I_CONFIRMATIONAPPLORIGIN

**Confirmationapplorigin**
...
|---|---|---|
| `_Text` | `I_ConfirmationApplOriginText` | [0..*] |
...
@Analytics.technicalName: 'ICONFAPPLORIGN'
...
@ObjectModel.sapObjectNodeType.name: 'OrderConfirmationOriginAppl'
@ObjectModel.usageType: {serviceQuality: #A, sizeCategory: #S, dataClass: #META}
@Search.searchable: true
@VDM.lifecycle.contract.type: #PUBLIC_LOCAL_API
@VDM.viewType: #BASIC
@EndUserText.label: 'Confirmation Application Origin'

/*+[hideWarning] { "IDS" : [ "CALCULATED_FIELD_CHECK", "KEY_CHECK" ]  } */
define root view entity I_ConfirmationApplOrigin
  as select from dd07l as l
  composition [0..*] of I_ConfirmationApplOriginText as _Text
{ 
    @ObjectModel.text.association: '_Text'
    // cast to data element  
    key cast(substring(l.domvalue_l, 1, 1) as ru_orina preserving type) as ConfirmationApplicationOrigin,
