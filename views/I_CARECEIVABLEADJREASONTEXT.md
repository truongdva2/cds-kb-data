...
tags:
  ...
  - lob:Finance
---
# I_CARECEIVABLEADJREASONTEXT

**Careceivableadjreasontext**
...
@EndUserText.label: 'Receivable Adjustment Reason - Text'
...
define view entity I_CAReceivableAdjReasonText
  as select from tfkzgrt

  association [0..1] to I_Language as _Language on $projection.Language = _Language.Language

{
  key grund as CAReceivableAdjustmentReason,
      @Semantics.language
      @ObjectModel.foreignKey.association: '_Language'
  key spras as Language,

      @Semantics.text
      txt30 as CAReceivableAdjustReasonName,
