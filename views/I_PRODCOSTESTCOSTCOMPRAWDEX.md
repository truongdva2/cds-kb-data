...
| Field | Data Source |
|---|---|
| `CostingReferenceObject` | `keph.CostingReferenceObject` |
| `CostEstimate` | `keph.CostEstimate` |
| `CostingType` | `keph.CostingType` |
| `CostingDate` | `keph.CostingDate` |
| `CostingVersion` | `keph.CostingVersion` |
| `ValuationVariant` | `keph.ValuationVariant` |
| `CostIsEnteredManually` | `keph.CostIsEnteredManually` |
| `CostingPartnerNumber` | `keph.CostingPartnerNumber` |
| `CostComponentSplitType` | `keph.CostComponentSplitType` |
| `CostIsInCtrlgAreaCrcy` | `keph.CostIsInCtrlgAreaCrcy` |
| `IsCostComponentSplitLowerLevel` | `keph.IsCostComponentSplitLowerLevel` |
| `CostEstWQSIsInclAdditiveCosts` | `keph.CostEstWQSIsInclAdditiveCosts` |
| `CostCompSpltDrctPrtnCharc` | `keph.CostCompSpltDrctPrtnCharc` |
| `Currency` | `cast(…)` |
