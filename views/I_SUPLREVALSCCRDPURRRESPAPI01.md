...
tags:
  ...
  - lob:Other
---
# I_SUPLREVALSCCRDPURRRESPAPI01

**Suplrevalsccrdpurrrespapi 01**
...
@AbapCatalog.sqlViewName: 'ISESCPURRSPAPI01'
@AccessControl.authorizationCheck: #CHECK
@AccessControl.personalData.blocking: #REQUIRED
@ClientHandling.algorithm: #SESSION_VARIABLE
@EndUserText.label: 'Purchaser Resp for Suplr Eval Scorecard'
...
define view I_SuplrEvalSccrdPurrRespAPI01
  as select from I_SuplrEvalScorecardPurchResp
{
