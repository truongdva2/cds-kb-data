...
semantic_en: "billing document item pricing element — itemized pricing conditions, rates and amounts for invoices."
semantic_vi: "yếu tố định giá mục tài liệu hóa đơn — điều kiện định giá, tỷ lệ và số tiền cho hóa đơn."
keywords:
  - định giá
  - mục hóa đơn
...
**Billing DocumentUMENTITEMPRCGELMNT**
...
| `BillingDocumentItem` | `PricingElement.BillingDocumentItem` |
...
@AbapCatalog.sqlViewName: 'ISDBILDOCITPE'
...
define view I_BillingDocumentItemPrcgElmnt
...

{
  ...
  key PricingElement.BillingDocumentItem,
