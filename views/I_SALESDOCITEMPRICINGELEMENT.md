...
| `SalesDocumentItem` | `cast(PricingDocumentItem as posnr_va preserving type)` |
...
@EndUserText.label: 'Sales Document Item Pricing Element'
@VDM: {
  viewType: #BASIC,
...
define view I_SalesDocItemPricingElement 
...

{
  ...
  key cast(PricingDocumentItem as posnr_va preserving type) as SalesDocumentItem,
