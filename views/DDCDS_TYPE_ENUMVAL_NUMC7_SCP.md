...
---
# DDCDS_TYPE_ENUMVAL_NUMC7_SCP

**Ddcds Type Enumval Numc 7 Scp**
...
| `enumValue` | `cast( enum.enumValue as abap.numc(7) )` |
| `_Text` | *Association* |
...
|---|---|---|
| `_Text` | `ddcds_type_enumval_numc7_t_scp` | [0..*] |
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC7'
define view entity ddcds_type_enumval_numc7_scp
  as select from dd_drty_st_enum_values_numc_7 as enum
  ...
  composition [0..*] of ddcds_type_enumval_numc7_t_scp as _Text
{
  ...
  key cast( enum.enumValue as abap.numc(7) )       as enumValue,
      _Text
}
```
