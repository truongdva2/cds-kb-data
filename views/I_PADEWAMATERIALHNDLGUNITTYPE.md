...
semantic_en: "PaDeWa condition records for material and handling unit type — assigns packing instructions based on material and handling unit type combination"
semantic_vi: "bản ghi điều kiện PaDeWa cho vật liệu và loại đơn vị xử lý — gán hướng dẫn đóng gói dựa trên kết hợp vật liệu và loại đơn vị xử lý"
keywords:
  - PaDeWa vật liệu
  - loại đơn vị xử lý
  - hướng dẫn đóng gói
...
tags:
  ...
  - bo:Material
---
# I_PADEWAMATERIALHNDLGUNITTYPE

**Padewamaterialhndlgunittype**
...
| `EWMWarehouse` | `PaInDetRec.ewm_warehouse_number` |
...
@EndUserText.label: 'PaDeWa for Material/Handling Unit Type'
...
define view entity I_PaDeWaMaterialHndlgUnitType
  as select from kotp484 as PaInDetRec
...

{
  ...
  key  PaInDetRec.ewm_warehouse_number                             as EWMWarehouse,
