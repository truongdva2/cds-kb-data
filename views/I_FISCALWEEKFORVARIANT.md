...
@Analytics.technicalName: 'IFIFISCWEEK4VAR'
...
define view entity I_FiscalWeekForVariant as select from P_FiscalYearWeek 
...
key P_FiscalYearWeek.FiscalWeek, 
    ...
    P_FiscalYearWeek.FiscalYearWeek, 
