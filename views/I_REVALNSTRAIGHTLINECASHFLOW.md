...
tags:
  ...
  - lob:Other
---
# I_REVALNSTRAIGHTLINECASHFLOW

**Revalnstraightlinecashflow**
...
@EndUserText.label: 'RE Valuation Straightline Cash Flow'
@Analytics: {
...
@ObjectModel: {
  ...
  sapObjectNodeType.name: 'REValnStrghtlnCashFlow'
}
@Metadata.ignorePropagatedAnnotations: true
@Metadata.allowExtensions: true
@VDM.viewType: #COMPOSITE
define view entity I_REValnStraightLineCashFlow
...
where
  REValuationCashflow.RECashFlowType = '5'
```
