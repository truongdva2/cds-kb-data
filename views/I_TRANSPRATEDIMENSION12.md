...
tags:
  ...
  - lob:Other
---
# I_TRANSPRATEDIMENSION12

**Transpratedimension 12**
...
@Analytics.technicalName: 'IRATEDIMN12'
@EndUserText: {label: 'Rate Table 12 Dimensional Rates'}
@ObjectModel: {sapObjectNodeType.name: 'TranspRateTableDimension12',
...
define view entity I_TranspRateDimension12
  as select from /scmtms/d_tcr12d as TranspRateDimn
