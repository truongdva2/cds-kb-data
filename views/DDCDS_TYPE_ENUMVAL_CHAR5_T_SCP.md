...
semantic_en: "Enumeration Value Character 5 with Text — five-character enumeration values with translated text labels."
semantic_vi: "Giá trị liệt kê Ký tự 5 có văn bản — giá trị liệt kê năm ký tự với nhãn văn bản được dịch."
keywords:
  - liệt kê
  - bản dịch
  - năm ký tự
...
---
# DDCDS_TYPE_ENUMVAL_CHAR5_T_SCP

**Ddcds Type Enumval Char 5 T Scp**
...
| `enumValue` | `cast( enum_t.enumValue as abap.char(5) )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_char5_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values CHAR5 Texts'
define view entity ddcds_type_enumval_char5_t_scp 
  as select from dd_drty_st_enum_value_t_char_5 as enum_t
  ...
  association to parent ddcds_type_enumval_char5_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                     ...
                                                                     and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.char(5) )       as enumValue,
  key enum_t.language,
