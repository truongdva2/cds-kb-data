...
---
# I_SETTLMTDOCITMSUPLRPRCGELMNT

**Settlmtdocitmsuplrprcgelmnt**
...
```abap
@EndUserText: {
  label: 'Settlmt Doc Item Suplr Pricing Element'
}
@VDM: {
  viewType: #COMPOSITE,
...
define view entity I_SettlmtDocItmSuplrPrcgElmnt
  as select from R_SettlmtDocItmSuplrPrcgElmnt
