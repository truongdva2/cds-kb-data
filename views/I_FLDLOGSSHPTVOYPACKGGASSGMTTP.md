...
tags:
  ...
  - bo:FldLogsShptVoyPackggAssignment
---
# I_FLDLOGSSHPTVOYPACKGGASSGMTTP

**Fldlogsshptvoypackggassgmttp**
...
@EndUserText.label: 'FL Shpt Voyage Packaging Assignment - TP'
...
@ObjectModel.sapObjectNodeType.name: 'FldLogsShptVoyPackggAssignment'
@AbapCatalog.extensibility: {
  extensible: true,
  elementSuffix: 'AGN',
  allowNewCompositions: true,
  allowNewDatasources: false,
  dataSources: ['ShptVoyPackggAsgn'],
  quota: {
    maximumFields: 1000,
    maximumBytes: 100000
  }
...
define view entity I_FldLogsShptVoyPackggAssgmtTP
  as projection on R_FldLogsShptVoyPackggAssgmtTP as ShptVoyPackggAsgn
{
