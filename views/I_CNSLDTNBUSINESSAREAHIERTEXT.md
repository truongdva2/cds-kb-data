...
semantic_en: "multilingual text for business area hierarchies — language-specific hierarchy descriptions"
semantic_vi: "văn bản đa ngôn ngữ cho phân cấp khu vực — mô tả phân cấp theo ngôn ngữ"
keywords:
  - văn bản phân cấp
  - tên phân cấp
  - khu vực
