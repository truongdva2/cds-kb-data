...
@Analytics.technicalName: 'IFIFYPERTXT' 
...
define view entity I_FiscalYearPeriodText as select from t009c inner join finsc_period on  t009c.periv = finsc_period.fiscal_year_variant
