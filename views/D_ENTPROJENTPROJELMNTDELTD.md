...
tags:
  ...
  - lob:Other
---
# D_ENTPROJENTPROJELMNTDELTD

**D Entprojentprojelmntdeltd**
...
```abap
@EndUserText.label: 'Enterprise Project Element Deleted'
@Event:{
...
define abstract entity D_EntProjEntProjElmntDeltd {
    ProjectElementUUID : /s4ppm/tv_entity_guid;
    ProjectElement : /s4ppm/tv_external_id;
}
```
