...
tags:
  ...
  - bo:Project
---
# I_PROJECTBOMSUBITEMDEX

**Projectbomsubitemdex**
...
@EndUserText.label: 'WBS BOM Subitem Extraction'
...
@ObjectModel.sapObjectNodeType.name : 'WBSBillOfMaterialSubitem'
@Analytics:{
     dataCategory: #FACT,
     dataExtraction: {
        enabled: true,
...
define view entity I_ProjectBOMSubitemDEX as select from P_ProjectBOMSubitemDEX
{
   key BillOfMaterial,
