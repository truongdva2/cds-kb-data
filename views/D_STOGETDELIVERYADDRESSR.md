...
---
# D_STOGETDELIVERYADDRESSR

**D Stogetdeliveryaddressr**
...
| `StockTransportOrderItem` | `vdm_stocktransportorderitem` |
...
@EndUserText.label: 'Get Delivery Address details for STO'
define root abstract entity D_STOGetDeliveryAddressR
{
  StockTransportOrder          : vdm_stocktransportorder;
  StockTransportOrderItem      : vdm_stocktransportorderitem;
  AddressID                    : ad_addrnum;
