...
tags:
  ...
  - lob:Other
---
# I_TRANSPORDERCATEGORY_2

**Transpordercategory 2**
...
|---|---|---|
| `_Text` | `I_TranspOrderCategoryT_2` | [0..*] |
...
@EndUserText.label: 'Transportation Order Category'
@Metadata.ignorePropagatedAnnotations: true
@ObjectModel.sapObjectNodeType.name: 'TransportationOrderCategory'
...
define root view entity I_TranspOrderCategory_2
  as select from dd07l
  composition [0..*] of I_TranspOrderCategoryT_2 as _Text
{
