...
| `Ledger` | `I_CoCodeLedgerSourceLedger.Ledger` |
...
| `Material` | `cast(I_GLAccountLineItemRawData.Product as matnr preserving type )` |
...
| `ClearingDocFiscalYear` | `cast(…)` |
| `ClearingAccountingDocument` | `cast(…)` |
...
| `InventorySpecialStockValnType` | `cast(…)` |
...
| `InvtrySpclStockWBSElmntIntID` | `cast(…)` |
| `InventorySpclStockWBSElement` | `cast(…)` |
...
| `CurPlanProjSlsOrdValnStrategy` | `I_GLAccountLineItemRawData.CurPlanProjSlsOrdValnStrategy` |
...
| `OriginOrder` | `I_GLAccountLineItemRawData.OriginOrder` |
...
| `WBSElement` | `cast( I_GLAccountLineItemRawData.WBSElement as fis_wbs preserving type )` |
...
| `Project` | `cast( I_GLAccountLineItemRawData.Project as fis_project preserving type )` |
...
| `PartnerOrder` | `cast(…)` |
| `PartnerOrder_2` | `cast(I_GLAccountLineItemRawData.PartnerOrder as fis_par_aufnr preserving type )` |
| `PartnerOrderCategory` | `I_GLAccountLineItemRawData.PartnerOrderCategory` |
| `PartnerWBSElement` | `cast(…)` |
| `PartnerProject` | `cast(…)` |
...
| `VarianceOriginGroup` | `I_GLAccountLineItemRawData.VarianceOriginGroup` |
...
| `DebitAmountInCoCodeCrcy` | `case…end` |
| `CreditAmountInCoCodeCrcy` | `case…end` |
| `DebitAmountInTransCrcy` | `case…end` |
| `CreditAmountInTransCrcy` | `case…end` |
| `DebitAmountInBalanceTransCrcy` | `case…end` |
| `CreditAmountInBalanceTransCrcy` | `case…end` |
| `DebitAmountInGlobalCrcy` | `case…end` |
| `CreditAmountInGlobalCrcy` | `case…end` |
| `DebitAmountInFunctionalCrcy` | `case…end` |
| `CreditAmountInFunctionalCrcy` | `case…end` |
| `DebitAmountInFreeDefinedCrcy1` | `case…end` |
| `CreditAmountInFreeDefinedCrcy1` | `case…end` |
| `DebitAmountInFreeDefinedCrcy2` | `case…end` |
| `CreditAmountInFreeDefinedCrcy2` | `case…end` |
| `DebitAmountInFreeDefinedCrcy3` | `case…end` |
| `CreditAmountInFreeDefinedCrcy3` | `case…end` |
| `DebitAmountInFreeDefinedCrcy4` | `case…end` |
| `CreditAmountInFreeDefinedCrcy4` | `case…end` |
| `DebitAmountInFreeDefinedCrcy5` | `case…end` |
| `CreditAmountInFreeDefinedCrcy5` | `case…end` |
| `DebitAmountInFreeDefinedCrcy6` | `case…end` |
| `CreditAmountInFreeDefinedCrcy6` | `case…end` |
| `DebitAmountInFreeDefinedCrcy7` | `case…end` |
| `CreditAmountInFreeDefinedCrcy7` | `case…end` |
| `DebitAmountInFreeDefinedCrcy8` | `case…end` |
| `CreditAmountInFreeDefinedCrcy8` | `case…end` |
| `IsStatisticalOrder` | `cast(…)` |
| `IsStatisticalCostCenter` | `cast(…)` |
| `IsStatisticalSalesDocument` | `cast(…)` |
| `WBSIsStatisticalWBSElement` | `cast(…)` |
| `NumberOfItems` | `cast( cast(1 as abap.dec( 12, 0 )) as fis_nbritm preserving type )` |
...
| `_InvtrySpclStockWBSElmntBD` | *Association* |
...
| `_CurrentPartnerCostCenter` | *Association* |
| `_PartnerProfitCenter` | *Association* |
| `_CurrentPartnerProfitCenter` | *Association* |
...
| `_CurrentPartnerCostCtrActyType` | *Association* |
...
| `_LedgerCompanyCodeCrcyRoles` | *Association* |
...
| `GLAccountAuthorizationGroup` | `cast( '' as fis_brgru_glaccount)` |
| `SupplierBasicAuthorizationGrp` | `cast( '' as fis_brgru_supplier)` |
| `CustomerBasicAuthorizationGrp` | `cast( '' as fis_brgru_customer)` |
| `AcctgDocTypeAuthorizationGroup` | `cast( '' as fis_brgru_acctgdoctype)` |
