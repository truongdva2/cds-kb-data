...
```abap
@EndUserText.label: 'BO Intf for Cont Unit Voyages - TP'
...
define view entity I_FldLogsShptStgeAssgmtCtnTP
  as projection on R_FldLogsShptStgeAssgmtCtnTP as FldLogsShptStgAsgn
{
