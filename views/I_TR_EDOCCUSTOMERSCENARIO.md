...
tags:
  ...
  - bo:Customer
---
# I_TR_EDOCCUSTOMERSCENARIO

**TR Edoccustomerscenario**
...
@EndUserText.label: 'eDocument Turkey Customer Scenarios'
...
define view entity I_TR_EDocCustomerScenario as select from R_TR_EDocCustomerScenario
{
