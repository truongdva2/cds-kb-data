...
| `MaintComponentItemCategory` | `MaintOrdOpCompItemCategory` |
...
```abap
@EndUserText.label: 'Maint Order Component Projection - TP'
...
define view entity I_MaintOrderOpComponentTP_2
  as projection on R_MaintOrderOpComponentTP_2
{
  ...
  key MaintOrderComponentInternalID,
      ...
      _MaintOrderOpCompLongText  : redirected to composition child I_MaintOrderOpCompLongTextTP
}
```
