...
tags:
  ...
  - bo:Supplier
---
# I_PADEWASUPPLIERMATERIAL

**Padewasuppliermaterial**
...
@EndUserText.label: 'PaDeWa for Supplier/Material'
...
define view entity I_PaDeWaSupplierMaterial
  as select from kotp483 as PaInDetRec
