...
tags:
  ...
  - lob:Other
---
# I_SRVCORDFUPSRVCENTRSHEETTP

**Srvcordfupsrvcentrsheettp**
...
@EndUserText.label: 'Follow-Up Service Entry Sheet - TP'
@VDM: {
...
define view entity I_SrvcOrdFUPSrvcEntrSheetTP
as projection on R_SrvcOrdFUPSrvcEntrSheetTP 
{
  key ServiceOrder,
