...
semantic_en: "Enumeration Value Character 3 with Text — three-character enumeration values with translated text labels."
semantic_vi: "Giá trị liệt kê Ký tự 3 có văn bản — giá trị liệt kê ba ký tự với nhãn văn bản được dịch."
keywords:
  - liệt kê
  - bản dịch
  - ba ký tự
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_char3_scp` | — |
