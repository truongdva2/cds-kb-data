...
```abap
@AbapCatalog.sqlViewName: 'IPPOPSUPGRCATTXT'
...
@VDM.viewType: #BASIC
@EndUserText.label: 'Operation Setup Group Category - Text'
@ObjectModel.sapObjectNodeType.name: 'BOOOpSetUpGroupCatText'
@Analytics.dataExtraction.enabled: true


define view I_OperationSetupGroupCatText
  as select from t426t as txt
  ...
  association [1..1] to I_Plant    as _Plant    on $projection.Plant = _Plant.Plant
{
  ...
  key cast(txt.rfgrp as vdm_ruefagrp preserving type) as OperationSetupGroupCategory,
      @ObjectModel.foreignKey.association: '_Language'
      @Semantics.language: true
  key txt.spras                                       as Language,
      @Search: {defaultSearchElement: true, ranking: #HIGH, fuzzinessThreshold: 0.8}
      @Semantics.text: true
      txt.txt                                         as OperationSetupGroupCatName,
