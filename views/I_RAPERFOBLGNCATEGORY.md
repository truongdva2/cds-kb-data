...
@Analytics.technicalName: 'IRAPOBCAT'

@Consumption.ranked: true

@EndUserText.label: 'RA Performance Obligation Category'
...
define root view entity I_RAPerfOblgnCategory
  as select from dd07l

  composition [0..*] of I_RAPerfOblgnCategoryText as _Text

{
      @ObjectModel.text.association: '_Text'
  key cast(dd07l.domvalue_l as farr_cds_pob_category) as RAPerfOblgnCategory,
...
where dd07l.domname  = 'FARR_POB_CATEGORY'
