...
---
# I_PRODNRTGOPEQUIPPRTASSGMTTP_2

**Prodnrtgopequipprtassgmttp 2**
...
```abap
@EndUserText.label: 'Interface for BO ProductionRouting Equip PRT Assignment - TP'
...
define view entity I_ProdnRtgOpEquipPRTAssgmtTP_2
  as projection on R_ProdnRtgOpEquipPRTAssgmtTP_2
{
