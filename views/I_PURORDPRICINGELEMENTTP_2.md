...
---
# I_PURORDPRICINGELEMENTTP_2

**Purordpricingelementtp 2**
...
```abap
@EndUserText.label: 'PO Pricing Element Projection'
...
define view entity I_PurOrdPricingElementTP_2
  as projection on R_PurOrderItemPricingElementTP
{
  key PurchaseOrder,
