...
@EndUserText.label: 'Follow-Up Purchase Requisition - TP'
@VDM: {
...
define view entity I_SrvcOrdFUPPurReqnTP
 as projection on R_SrvcOrdFUPPurReqnTP
{
key ServiceOrder,
