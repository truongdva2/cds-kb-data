...
tags:
  ...
  - bo:Plant
---
# I_CNSLDTNPLANTHIERARCHYNODET

**Cnsldtnplanthierarchynodet**
...
@ObjectModel:{
  ...
  sapObjectNodeType.name: 'CnsldtnPlantHierNodeText'                        
}
@VDM:{
  viewType: #BASIC,
  lifecycle.contract.type: #PUBLIC_LOCAL_API
}
@EndUserText.label: 'Cnsldtn Plant Hierarchy Node - Text'
/*+[hideWarning] { "IDS" : [ "KEY_CHECK", "CARDINALITY_CHECK" ]  } */
define view entity I_CnsldtnPlantHierarchyNodeT
  as select from P_CnsldtnUnivHierNodeText_3(P_HierarchyType: 'CS31', P_MasterDataType: 'WERKS') as _HierarchyNodeText

  association [1..1] to I_CnsldtnPlantHierarchy as _Hierarchy on $projection.CnsldtnPlantHierarchy = _Hierarchy.CnsldtnPlantHierarchy // no validity date condition due to limitation in analytic engine

{
  ...
  key cast(_HierarchyNodeText.UniversalHierarchy as fincs_planthierarchy preserving type ) as CnsldtnPlantHierarchy,
