...
semantic_en: "Enumeration values with translations for numeric data type NUMC8 — simpleType, enumIdentifier, enumValue, language, enumTextName, enumText"
semantic_vi: "Giá trị liệt kê có bản dịch cho kiểu dữ liệu số NUMC8 — bao gồm loại đơn giản, định danh, giá trị, ngôn ngữ, tên văn bản, nội dung văn bản"
keywords:
  - liệt kê
  - dịch thuật
  - NUMC8
...
---
# DDCDS_TYPE_ENUMVAL_NUMC8_T_SCP

**Ddcds Type Enumval Numc 8 T Scp**
...
| `enumValue` | `cast( enum_t.enumValue as abap.numc(8) )` |
...
|---|---|---|
| `_EnumValue` | `ddcds_type_enumval_numc8_scp` | — |
...
@EndUserText.label: 'CDS Simple Type: Enum Values NUMC8 Texts'
define view entity ddcds_type_enumval_numc8_t_scp
  as select from dd_drty_st_enum_value_t_numc_8 as enum_t
  ...
  association to parent ddcds_type_enumval_numc8_scp as _EnumValue on  $projection.simpleType     = _EnumValue.simpleType
                                                                   ...
                                                                   and $projection.enumValue      = _EnumValue.enumValue
{
  ...
  key cast( enum_t.enumValue as abap.numc(8) )        as enumValue,
  key enum_t.language,
