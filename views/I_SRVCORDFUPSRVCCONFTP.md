...
tags:
  ...
  - lob:Other
---
# I_SRVCORDFUPSRVCCONFTP

**Srvcordfupsrvcconftp**
...
@EndUserText.label: 'Follow-Up Service Confirmation - TP'
@VDM: {
...
define view entity I_SrvcOrdFUPSrvcConfTP 
as projection on R_SrvcOrdFUPSrvcConfTP
{
  key ServiceOrder,
