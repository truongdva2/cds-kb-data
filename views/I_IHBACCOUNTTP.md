...
```abap
@EndUserText.label: 'IHB Account - TP'
...
@ObjectModel: {
   ...
   semanticKey: ['IHBAccountUUID']
 }
@AbapCatalog.extensibility: {
  extensible: true,
  elementSuffix: 'IHB', 
  dataSources: ['IHBAccount'],  
  quota: {
    maximumFields: 204,
    maximumBytes: 6800
  }  
...
define root view entity I_IHBAccountTP
provider contract transactional_interface
  as projection on R_IHBAccountTP as IHBAccount


{
  key IHBAccount.IHBAccountUUID,
  ...
  @Semantics.amount.currencyCode: 'IHBAccountCurrency'
  ...
  ApplicationLogHandle,
      //Compositions
      _IHBAccountBPBalNotifTP           : redirected to composition child I_IHBAccountBPBalNotifTP,
      _IHBAccountBPBkStmntTP            : redirected to composition child I_IHBAccountBPBkStmntTP,
      _IHBAccountBPIntrstScNotifTP      : redirected to composition child I_IHBAccountBPIntrstScNotifTP,
      _IHBAccountTTP                    : redirected to composition child I_IHBAccountTextTP
