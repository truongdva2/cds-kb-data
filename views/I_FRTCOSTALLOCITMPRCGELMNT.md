...
---
# I_FRTCOSTALLOCITMPRCGELMNT

**Frtcostallocitmprcgelmnt**
...
| `_FrtCostAllocItm` | `I_FrtCostAllocItm` | [1..1] |

## Source Code

```abap
@EndUserText.label: 'Frt Cost Allocation Item Pricing Element' 
...
define view entity I_FrtCostAllocItmPrcgElmnt
  as select from R_FrtCostAllocItmPrcgElmnt
  ...
  association [1..1] to I_FrtCostAllocItm as _FrtCostAllocItm on  $projection.FreightCostAllocationDocument = _FrtCostAllocItm.FreightCostAllocationDocument
