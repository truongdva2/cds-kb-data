...
tags:
  ...
  - lob:Finance
---
# I_FINSGLAVGDAILYBALKEYFIGC

**Finsglavgdailybalkeyfigc**
...
@Analytics: {  dataCategory: #CUBE,
               internalName: #LOCAL }
@EndUserText.label: 'ADB Key Figures - Cube'

define view entity I_FinSGLAvgDailyBalKeyFigC
  with parameters
    P_ReportingDate : sydate,
    P_CreationDate  : sydate,
    P_CreationTime  : syuzeit
  as select from P_FinsGLAvgDailyBalCalc(
